...
import { getOpenTodos, getPrefs, getUnsortedIdeas, isOnToday } from "@/lib/data";
...
export default async function AppLayout({
  ...
  const [open, tz, prefs, unsorted] = await Promise.all([
    getOpenTodos(),
    getTimeZone(),
    getPrefs(),
    getUnsortedIdeas(),
  ...
  const loose = looseEndsCount(open, unsorted.length);
